...
const DrawerList = [
  ...
  {icon: 'cogs', label: 'Paramètres', navigateTo: 'Parametres'},
];
          ...
          <TouchableOpacity activeOpacity={0.8}>
            <View style={styles.userInfoSection}>
              <View style={{flexDirection: 'row', marginTop: 15}}>
                ...
                {auth().currentUser && <Title style={styles.title}>{auth().currentUser.displayName}</Title>}
                {auth().currentUser && <Text style={styles.caption} numberOfLines={1}>{auth().currentUser.email}</Text>}
                </View>
              </View>
            </View>
          </TouchableOpacity>
